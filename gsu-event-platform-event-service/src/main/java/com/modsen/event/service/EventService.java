...
public interface EventService {
    ...
    Page<EventResponse> getEventsByOrganizer(UUID organizerId, int page, int size);
    Page<EventResponse> getEventsByStatus(EventStatus status, int page, int size);
    Page<EventResponse> getEventsBetweenDates(LocalDateTime start, LocalDateTime end, int page, int size);
    Page<EventResponse> searchEvents(String query, int page, int size);
